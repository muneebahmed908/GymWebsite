...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/favicon.ico">s
...
<form>
  ...
  <div class="form-group">
    ...
    <input type="text" name="dob" class="form-control" id="inputperiod" placeholder="dob">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <button type="Submit" name="Submit" class="form-control">save</button>
  </div>
</form>
